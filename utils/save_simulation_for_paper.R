save_simulation_for_paper <- function(result,
                                      simulation_type,
                                      path){
  path_csv <- file.path(path, paste0(config$simulation_type, "simulation"))
  ...
  write.csv(cse_dataLDA, file = cseEDDA_file, row.names = FALSE)
